...
ALLOWED_HOSTS = ['.onrender.com', 'localhost', '127.0.0.1', '10.12.5.227', ]
...
MIDDLEWARE = [
    ...
    'jobs.middleware.Custom404Middleware',
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'job.porta.finder@gmail.com'        # Your Gmail address
EMAIL_HOST_PASSWORD = 'sqqy ufru gtti dwtr'       # App password, not your Gmail login password
